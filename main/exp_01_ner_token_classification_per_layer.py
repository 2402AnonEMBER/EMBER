...
parser.add_argument("--hfcache", type=str, default="", help="huggingface cache")
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        for loader, loadername in zip([dataloader_validation, dataloader_test], ["validation", "test"]):
            ...
            metric_classwise = MulticlassF1Score(num_classes=len(get_iob_labels(dataset_id)), average=None, device=classifier.device)
